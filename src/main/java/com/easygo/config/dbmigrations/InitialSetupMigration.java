package com.easygo.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addAuthorities(MongoTemplate mongoTemplate) {
        ...
        userAuthority.setName(AuthoritiesConstants.CUSTOMER);
        Authority vendorAuthority = new Authority();
        vendorAuthority.setName(AuthoritiesConstants.VENDOR);
        Authority delivererAuthority = new Authority();
        delivererAuthority.setName(AuthoritiesConstants.DELIVERER);
        
        mongoTemplate.save(adminAuthority);
        mongoTemplate.save(userAuthority);
        mongoTemplate.save(vendorAuthority);
        mongoTemplate.save(delivererAuthority);
    }
